      ...
      _.each(clauses, function (clause) {                                                                              // 806
        ...
        handles.push(Blaze._EventSupport.listen(                                                                       // 813
          ...
          function (evt) {                                                                                             // 815
            ...
            return Blaze._withCurrentView(Blaze.getView(evt.currentTarget),                                            // 820
              function () {                                                                                            // 821
                return handler.apply(handlerThis, handlerArgs);                                                        // 822
              });                                                                                                      // 823
          },                                                                                                           // 824
          range, function (r) {                                                                                        // 825
            return r.parentRange;                                                                                      // 826
          }));                                                                                                         // 827
      });                                                                                                              // 828
    });                                                                                                                // 829
  });                                                                                                                  // 830
                                                                                                                       // 831
  view.onViewDestroyed(function () {                                                                                   // 832
    _.each(handles, function (h) {                                                                                     // 833
      h.stop();                                                                                                        // 834
    });                                                                                                                // 835
    handles.length = 0;                                                                                                // 836
  });                                                                                                                  // 837
};                                                                                                                     // 838
                                                                                                                       // 839
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
 ...
 * on server.                                                                                                          // 336
 * @param {Function|Object} [callbacks] Optional. May include `onError` and                                            // 337
 ...
 * - Inside a helper, returns the data context of the DOM node where the helper                                        // 493
 * was used.                                                                                                           // 494
 * - Inside an event handler, returns the data context of the element that fired                                       // 495
 * the event.                                                                                                          // 496
 *                                                                                                                     // 497
